...
def test_favourite_tv_show
  result = favourite_tv_show(@person5[:favourites])
...
def test_food_lkes
  result = food_likes(@person4, "ratatouille")
...
def test_remove_friend
  result = remove_friend(@person1, "Velma")
  assert_equal("Fred, Daphne, Scooby", result)
end
...
def test_total_money
  ...
  asser_equal(143, total_money(@people))
end
