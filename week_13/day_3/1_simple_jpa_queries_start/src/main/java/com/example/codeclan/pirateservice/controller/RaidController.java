...
public class RaidController {
    ...
    @GetMapping(value = "location/{locationName}")
    public List<Raid> getAllRaidsForLocation(@PathVariable String locationName){
        return raidRepository.findRaidByLocation(locationName);
    }
